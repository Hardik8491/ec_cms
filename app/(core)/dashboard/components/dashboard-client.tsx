...
export default function DashboardClient() {
  ...
  const { data, loading, error, timeRange, fetchData, setTimeRange } = useDashboardStore();
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Active stores in your agency</p>
          </CardContent>
        </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Revenue over the last {timeRange}</CardDescription>
              </CardHeader>
              <CardContent>
                <ChartContainer
                  config={{
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Orders over the last {timeRange}</CardDescription>
              </CardHeader>
              <CardContent>
                <ChartContainer
                  config={{
        ...
        <TabsContent value="stores" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage and monitor all your stores</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {data.stores.map((store) => (
                  <div key={store.id} className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <Link href={`/agency/stores/${store.id}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Detailed insights across all stores</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-green-50 rounded-lg">
                      <div className="text-2xl font-bold text-green-600">
                        {(data.overview.totalRevenue / data.overview.totalOrders || 0).toFixed(2)}
                      </div>
                      <div className="text-sm text-green-700">Average Order Value</div>
                    </div>
                    <div className="p-4 bg-blue-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600">
                        {(data.overview.totalOrders / data.overview.totalCustomers || 0).toFixed(2)}
                      </div>
                      <div className="text-sm text-blue-700">Orders per Customer</div>
                    </div>
                  </div>
                </div>
              </CardContent>
