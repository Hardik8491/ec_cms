                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    >
                        ...
                        <p className='text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed'>
                            Build, manage, and scale your e-commerce empire with
                            AI-powered insights, real-time analytics, and
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center mb-16'>
                        ...
                        <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
                            Everything you need to build, manage, and scale your
                            e-commerce business with AI-powered automation.
                        </p>
                    </div>
            ...
            <section className='py-20 bg-white'>
                <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
                    ...
                    <p className='text-xl text-gray-600 mb-8'>
                        Join thousands of businesses already using EC-OS to
                        scale their operations with AI-powered automation.
                    </p>
            ...
            <footer className='bg-gray-900 text-white py-16'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
                        <div>
                            ...
                            <p className='text-gray-400 mb-4'>
                                The future of e-commerce management with
                                AI-powered automation and real-time insights.
                            </p>
                    ...
                    <div className='border-t border-gray-800 mt-12 pt-8 text-center text-gray-400'>
                        <p>
                            &copy; 2025 EC-OS. All rights reserved. Built with
                            ❤️ for the future of e-commerce.
                        </p>
                    </div>
                </div>
            </footer>
